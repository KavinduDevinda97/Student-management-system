...
<div class="container-fluid py-4">
    <div class="card">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            <div>
                <h5 class="mb-0 text-primary">Course Application</h5>
                <p class="text-muted mb-0 small">Manage your courses</p>
            </div>
            <a href="{{ url('/courses/create') }}" class="btn btn-success d-flex align-items-center">
                ...
                <table class="table table-hover align-middle">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th scope="col" width="15%">Syllabus</th>
